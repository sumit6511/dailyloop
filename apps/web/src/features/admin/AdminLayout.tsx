  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <nav className="mt-4 flex gap-1 overflow-x-auto border-b border-white/[0.1]">
          {TABS.map((tab) => (
            <NavLink
              key={tab.to}
              to={tab.to}
              ...
              className={({ isActive }) =>
                `flex shrink-0 items-center gap-1.5 border-b-2 px-3 py-2 text-sm font-semibold transition-colors ${
